...
function Aboutus() {
  ...
  useGSAP(() => {
    ...
    gsap.to(".section-jake-content", {
      ...
      delay: 4,
      text: {
        value: "As the visionary behind Dimensional, Jake brings boundless creativity and an unwavering commitment to innovation. With a keen eye for detail and a passion for pushing boundaries, Jake leads our team in crafting unique and impactful experiences for our users.",
        speed: 4,
    ...
    gsap.to(".section-eric-content", {
      ...
      delay: 4,
      text: {
        value: "Meet Eric, the mastermind behind the architecture and functionality of our platform. With a knack for turning ideas into reality, Eric ensures that every feature is not only aesthetically pleasing but also seamlessly functional. Their dedication to perfection and precision is the cornerstone of our success.",
        speed: 5
      }
    });
  ...
  return (
    <div className="aboutus">
      ...
      <section className="section-jake">
        ...
        <p className="socials">
        <p className="socialsalign"><img src={github}/>:Jaketattersall</p>
        <p className="socialsalign"><EnvelopeSimple size={32} />:Jaketattersall90@gmail.com</p>
      </p>
      </section>
      ...
      <p className="socials">
        <p className="socialsalign"><img src={github}/>:Daniel-pho</p>
        <p className="socialsalign"><EnvelopeSimple size={32} />:daniel-phou@hotmail.com</p>
      </p>
      </section>
      ...
      <p className="socials">
        <p className="socialsalign"><img src={github}/>:EricLeeCodes</p>
        <p className="socialsalign"><EnvelopeSimple size={32} />:ericleecodes@gmail.com</p>
      </p>
      </section>
    </div>
  );
